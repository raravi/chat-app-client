...
export const ForgotPassword = (props) => {
  return (
    <section className="forgot-password">
      ...
      <label className="forgot-password__email-error">{props.forgotPasswordState.emailError}</label>
      <label className="forgot-password__email-success">{props.forgotPasswordState.emailSuccess}</label><br />
